  ...
  public function execute() {
    try {
      if (request::getInstance()->hasGet('id')) {
        ...
        $this->ambiente = ambienteTableClass::getAmbienteById($id);
        $this->edit = true;
        ...
        $this->defineView('edit', 'ambiente', session::getInstance()->getFormatOutput());
      } else {
      ...
      switch ($exc->getCode()) {
        case 23505:
          session::getInstance()->setError('El Ambiente que intenta registar ya existe en la base de datos');
          break;
        case 00006:
      ...
      routing::getInstance()->redirect('ambiente', 'edit');
