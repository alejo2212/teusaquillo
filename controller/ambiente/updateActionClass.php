  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        $id = request::getInstance()->getPost(ambienteTableClass::getNameField(ambienteTableClass::ID, true));
        ...
        ambienteTableClass::update($ids, $data);
...
//          break;
      ...
      routing::getInstance()->redirect('ambiente', 'edit', array(ambienteBaseTableClass::ID => $id));
