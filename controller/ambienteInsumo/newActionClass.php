...
class newActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
      if (session::getInstance()->hasAttribute('form')) {
            $ambienteInsumo = session::getInstance()->getAttribute('form');
            session::getInstance()->setFlash('ambienteInsumo', $ambienteInsumo);
            }
    ...
    $this->defineView('new', 'ambienteInsumo', session::getInstance()->getFormatOutput());
  }
