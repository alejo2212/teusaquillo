    ...
    public function execute() {
        try {
            if (request::getInstance()->isMethod('POST')) {
                ...
                $idEmpleado = request::getInstance()->getPost(empleadoTableClass::getNameField(empleadoTableClass::ID, true));
                ...
                $post = array(
                    ...
                    controlCucarronTableClass::EMPLEADO_ID_RESPONSABLE => $idEmpleado,
                ...
                session::getInstance()->setAttribute(controlCucarronTableClass::getNameField(controlCucarronTableClass::FECHA_REALIZACION, true), $fechare);
                ...
                controlCucarronTableClass::insert($data);
            ...
            switch ($exc->getCode()) {
                case 23505:
                    session::getInstance()->setError('El control Cucarron que intenta registar ya existe en la base de datos');
                    break;
                case 00006:
...
//                    break;
                case 23503:
                    session::getInstance()->setWarning('El numero de salida insumo no existe');
                    break;
                default:
                    session::getInstance()->setWarning($exc->getMessage());
                    break;
            }
            routing::getInstance()->redirect('controlCucarron', 'new');
