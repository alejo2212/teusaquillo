    ...
    public function execute() {
        try {
            if (request::getInstance()->isMethod('POST')) {
                ...
                $eviconsu = request::getInstance()->getPost(controlRoedoresTableClass::getNameField(controlRoedoresTableClass::EVIDENCIA_CONSUMO, true));
                ...
                $post = array(
                    ...
                    controlRoedoresTableClass::EMPLEADO_ID_RESPONSABLE => $idEmpleado,
                ...
                session::getInstance()->setAttribute(controlRoedoresTableClass::getNameField(controlRoedoresTableClass::FECHA_REALIZACION, true), $fechare);
                ...
                controlRoedoresTableClass::insert($data);
...
//                    break;
            ...
            routing::getInstance()->redirect('controlRoedores', 'new');
