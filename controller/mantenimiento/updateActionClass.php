  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        $id = request::getInstance()->getPost(mantenimientoTableClass::getNameField(mantenimientoTableClass::ID, true));
        ...
        mantenimientoTableClass::update($ids, $data);
