...
class updateActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        routing::getInstance()->redirect('maquinaria', 'index');
      } else {
        routing::getInstance()->redirect('maquinaria', 'index');
      }
      ...
      routing::getInstance()->redirect('maquinaria', 'edit', array(maquinaTableClass::ID=>$id));
  ...
  public function Validations($clasiMaqui,$fechaIngre,$descrip,$codigo,$referencia,$fechaMante,$intervaloMante,$activo,$valor) {
    ...
    if (strlen($referencia) > maquinaTableClass::REFERENCIA) {
