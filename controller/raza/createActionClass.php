...
//        exit();
        ...
        session::getInstance()->setAttribute(razaTableClass::getNameField(razaTableClass::NOMBRE, true), $nombre);
...
//          break;
      ...
      routing::getInstance()->redirect('raza', 'new');
