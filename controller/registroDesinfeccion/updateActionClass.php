  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        $id = request::getInstance()->getPost(registroDesinfeccionTableClass::getNameField(registroDesinfeccionTableClass::ID, true));
        ...
        //
                $this->validations($fechare, $fechater, $insumo, $solucion, $observacion, $tipdesin, $cantPediluvios, $desBodega, $desPediluvios, $desRamadas);

        /* ------------- */

        $ids = array(
            registroDesinfeccionTableClass::ID => $id
        );
        ...
        registroDesinfeccionTableClass::update($ids, $data);
...
//          break;
      ...
      routing::getInstance()->redirect('registroDesinfeccion', 'edit', array(registroDesinfeccionTableClass::ID => $id));
      //routing::getInstance()->forward('security', 'new');
    }
  }

  private function validations($fechare, $fechater, $insumo, $solucion, $observacion, $tipdesin, $cantPediluvios, $desBodega, $desPediluvios, $desRamadas) {
