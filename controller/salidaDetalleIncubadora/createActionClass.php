...
//        }
        salidaDetalleIncubadoraTableClass::insert($data);
      ...
      routing::getInstance()->redirect('salidaDetalleIncubadora', 'new', array(salidaincubadoraTableClass::ID . 'Salida' => $salidaid));
