...
//                $fecha = request::getInstance()->getPost(salidaInsumoTableClass::getNameField(salidaInsumoTableClass::FECHA, true));
                ...
                session::getInstance()->setAttribute(salidaInsumoTableClass::getNameField(salidaInsumoTableClass::OBSERVACION, true), $user);
                ...
                salidaInsumoTableClass::insert($data);
                session::getInstance()->setSuccess('Registro exitoso');
                $id = salidaInsumoTableClass::getIdSalidaInsumo();

                routing::getInstance()->redirect('salidaInsumoDetalle', 'new', array(salidaInsumoTableClass::ID => $id));
            } else {
            ...
            switch ($exc->getCode()) {
//                case 23505:
//                    session::getInstance()->setError('La salida de Insumo que intenta registar ya existe en la base de datos');
//                    break;
                case 00006:
...
//                    break;
            ...
            routing::getInstance()->redirect('salidaInsumo', 'new');
...
//        echo 'fecha actual='.strtotime(date('Y-m-d H:i:s'));
//        echo '<br>';
//        echo 'fecha coloco='.strtotime($fecha);
//        exit();
//        
