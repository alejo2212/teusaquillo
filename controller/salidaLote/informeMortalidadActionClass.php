 ...
 */
class informeMortalidadActionClass extends controllerClass implements controllerActionInterface {
...
//
      ...
      $this->defineView('informeMortalidad', 'salidaLote', session::getInstance()->getFormatOutput());
