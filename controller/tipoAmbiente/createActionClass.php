...
//        }
                ...
                session::getInstance()->setAttribute(tipoAmbienteTableClass::getNameField(tipoAmbienteTableClass::NOMBRE, true), $nombre);
                session::getInstance()->setAttribute(tipoAmbienteTableClass::getNameField(tipoAmbienteTableClass::OBSERVACION, true), $observacion);
                session::getInstance()->setAttribute(tipoAmbienteTableClass::getNameField(tipoAmbienteTableClass::DESCRIPCION, true), $descripcion);
            ...
            routing::getInstance()->redirect('tipoAmbiente', 'new');
