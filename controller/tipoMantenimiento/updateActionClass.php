  ...
  public function execute() {
    try {
      ...
      if (request::getInstance()->isMethod('POST')) {
        ...
        $id = request::getInstance()->getPost(tipoMantenimientoTableClass::getNameField(tipoMantenimientoTableClass::ID, true));
        ...
        $ids = array(
            tipoMantenimientoTableClass::ID => $id
        );
         /**
         * VALIDACIONES
         */
        ...
        tipoMantenimientoTableClass::update($ids, $data);
      ...
      routing::getInstance()->redirect('tipoMantenimiento', 'edit', array(clasificacionMaquinaTableClass::ID=>$id));
