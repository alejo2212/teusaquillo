    ...
    public function execute() {
        try {
            ...
            if (request::getInstance()->isMethod('POST')) {
                ...
                $id = request::getInstance()->getPost(transportadorTableClass::getNameField(transportadorTableClass::ID, true));
                ...
                transportadorTableClass::update($ids, $data);
            ...
            routing::getInstance()->redirect('transportador', 'edit', array(transportadorTableClass::ID => $id));
