...
/**
 * Description of ambienteInsumoBaseTableClass
 *
 * @author Jhonny Alejandro <jhonny2212@hotmail.com>
 */
class ambienteInsumoBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const AMBIENTE_ID = 'ambiente_id';
  const SALIDA_INSUMO_DETALLE_ID = 'salida_insumo_detalle_id';
  const FECHA_ASIGNACION = 'fecha_asignacion';
  const FECHA_RETIRO = 'fecha_retiro';
  const DELETED_AT = 'deleted_at';

  static public function getNameTable() {
    return 'ambiente_insumo';
  }
