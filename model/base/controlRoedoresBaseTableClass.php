...
/**
 * Description of controlRoedoresBaseTableClass
 *
 * @author Patricia Arteaga <aprendiz.patricia-819@hotmail.com>
 */
class controlRoedoresBaseTableClass extends tableBaseClass {
  ...
  const EVIDENCIA_CONSUMO= 'evidencia_consumo';
  const LUGAR = 'lugar';
  const LUGAR_LENGTH = 1024;
