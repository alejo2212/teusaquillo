...
/**
 * Description of detaleMantenimientoBaseTableClass
 *
 * @author liliana carolina moreno <lilianacarol6@hotmail.com>
 */
class detalleMantenimientoBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const MANTENIMIENTO_ID = 'mantenimiento_id';
  const DESCRIPCION = 'descripocion';
  const DESCRIPCION_LENGTE = 1024;
  const VALOR = 'valor';
