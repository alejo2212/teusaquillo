...
/**
 * Description of salidaDetalleIncubadoraBaseTableClass
 *
 * @author Jhonny Alejandro <jhonny2212@hotmail.com>
 */
class salidaDetalleIncubadoraBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const SALIDA_INCUBADORA_ID = 'salida_incubadora_id';
  const CANTIDAD = 'cantidad';
  const DESCRIPCION = 'descripcion';
  const DESCRIPCION_LENGTH = 1024;
  const TIPO_EMPAQUE_ID = 'tipo_empaque_id';
  const CANTIDAD_EMPAQUE = 'cantidad_empaque';
  const DELETED_AT = 'deleted_at';

  static public function getNameTable() {
    return 'salida_detalle_incubadora';
  }
