...
/**
 * Description of salidaDetallePosturaBaseTableClass
 *
 * @author jhon fernando hoyos <jhonfernandohoyosdiaz@gmail.com>
 */
class salidaDetallePosturaBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const SALIDA_DETALLE_ID = 'salida_detalle_id';
  const POSTURA_DETALLE_ID = 'postura_detalle_id';
