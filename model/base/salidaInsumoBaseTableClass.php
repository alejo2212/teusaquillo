...
/**
 * Description of salidaInsumoBaseTableClass
 *
 * @author Jhonny Alejandro <jhonny2212@hotmail.com>
 */
class salidaInsumoBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const EMPLEADO_ID_SALIDA = 'empleado_id_salida';
  const EMPLEADO_ID_RECEPCION = 'empleado_id_recepcion';
  const FECHA = 'fecha';
