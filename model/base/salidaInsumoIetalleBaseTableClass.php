...
/**
 * Description of salidaInsumoDetalleBaseTableClass
 *
 * @author Jhonny Alejandro <jhonny2212@hotmail.com>
 */
class salidaInsumoDetalleBaseTableClass extends tableBaseClass {

  const ID = 'id';
  const SALIDA_INSUMO_ID = 'salida_insumo_id';
  const BODEGA_ID = 'bodega_id';
