...
class recordarMeTableClass extends recordarMeBaseTableClass {
  ...
  public static function clearSessions() { // :D
    try {
        // EXITO!!!!
      $sql = 'DELETE FROM ' . recordarMeTableClass::getNameTable() . ' WHERE localtimestamp(0) > (' . recordarMeTableClass::CREATED_AT . ' + INTERVAL \'' . config::getCookieTime() . ' seconds\')';
//      $params = array(
