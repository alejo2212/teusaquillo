<form class="form-horizontal" role="form" action="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('cargo', 'created') ?>" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="<?php echo cargoTableClass::getNameField(cargoTableClass::NOMBRE, true) ?>" name="<?php echo cargoTableClass::getNameField(cargoTableClass::NOMBRE, true) ?>" required>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="<?php echo cargoTableClass::getNameField(cargoTableClass::DESCRIPCION, true) ?>" name="<?php echo cargoTableClass::getNameField(cargoTableClass::DESCRIPCION, true) ?>" required>
    </div>
  </div>
  <div class="form-group">
