...
<form class="form-horizontal" role="form" action="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', (isset($edit) === true and $edit === true) ? 'update' : 'create') ?>" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="<?php echo tipoInsumoTableClass::getNameField(tipoInsumoTableClass::NOMBRE, true) ?>" name="<?php echo tipoInsumoTableClass::getNameField(tipoInsumoTableClass::NOMBRE, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objtipoInsumo->$nombre : '' ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="<?php echo tipoInsumoTableClass::getNameField(tipoInsumoTableClass::OBSERVACION, true) ?>" name="<?php echo tipoInsumoTableClass::getNameField(tipoInsumoTableClass::OBSERVACION, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objtipoInsumo->$observacion : '' ?>">
        </div>
    </div>
