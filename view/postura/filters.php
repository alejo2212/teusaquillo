...
<div class="modal fade" id="myModalFilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo mvc\routing\routingClass::getInstance()->getUrlWeb('postura', 'index') ?>" class="form-horizontal" role="form">
        <div class="modal-body">

          <div class="form-group">
            <label class="col-sm-4 control-label">Fecha de Realizacion</label>
            <div class="col-sm-8">
              <input type="date" class="form-control" id="<?php echo posturaTableClass::getNameField(posturaTableClass::FECHA, true) ?>_ini" name="<?php echo posturaTableClass::getNameField(posturaTableClass::FECHA, true) ?>_ini" placeholder="Fecha inicio">
              <br>
              <input type="date" class="form-control" id="<?php echo posturaTableClass::getNameField(posturaTableClass::FECHA, true) ?>_fin" name="<?php echo posturaTableClass::getNameField(posturaTableClass::FECHA, true) ?>_fin" placeholder="Fecha final">
            </div>
          </div>
          <div class="form-group">
