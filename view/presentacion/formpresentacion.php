...
<form class="form-horizontal" role="form" action="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('presentacion', (isset($edit) === true and $edit === true) ? 'update' : 'create') ?>" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="<?php echo presentacionTableClass::getNameField(presentacionTableClass::NOMBRE, true) ?>" name="<?php echo presentacionTableClass::getNameField(presentacionTableClass::NOMBRE, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objpresentacion->$nombre : '' ?>">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="<?php echo presentacionTableClass::getNameField(presentacionTableClass::OBSERVACION, true) ?>" name="<?php echo presentacionTableClass::getNameField(presentacionTableClass::OBSERVACION, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objpresentacion->$observacion : '' ?>">
    </div>
    </div>
  <div class="form-group">
