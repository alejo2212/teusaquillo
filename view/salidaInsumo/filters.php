...
<div class="modal fade" id="myModalFilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog MImodal-dialogSalInsu">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo mvc\routing\routingClass::getInstance()->getUrlWeb('salidaInsumo', 'index') ?>" class="form-horizontal" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="<?php echo salidaInsumoTableClass::getNameField(salidaInsumoTableClass::FECHA, true) ?>" class="col-sm-4 control-label"><?php echo i18nClass::__('fechacreacion') ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="<?php echo salidaInsumoTableClass::getNameField(salidaInsumoTableClass::EMPLEADO_ID_SALIDA, true) ?>" class="col-sm-4 control-label"><?php echo i18nClass::__('empleadoEntrega') ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="<?php echo salidaInsumoTableClass::getNameField(salidaInsumoTableClass::EMPLEADO_ID_RECEPCION, true) ?>" class="col-sm-4 control-label"><?php echo i18nClass::__('empleadoRecibe') ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="<?php echo salidaInsumoTableClass::getNameField(salidaInsumoTableClass::REQUISICION_ID, true) ?>" class="col-sm-4 control-label"><?php echo i18nClass::__('requisicion') ?></label>
                        <div class="col-sm-8">
