    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="<?php echo tipoAmbienteTableClass::getNameField(tipoAmbienteTableClass::OBSERVACION
                           , true)
?>" name="<?php echo tipoAmbienteTableClass::getNameField(tipoAmbienteTableClass::OBSERVACION, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $TipoAmbiente->$observacion : '' ?>">
        </div>
    </div>
