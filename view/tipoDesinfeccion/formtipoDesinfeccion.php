...
<form class="form-horizontal" role="form" action="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoDesinfeccion', (isset($edit) === true and $edit === true) ? 'update' : 'create') ?>" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="<?php echo tipoDesinfeccionTableClass::getNameField(tipoDesinfeccionTableClass::NOMBRE, true) ?>" name="<?php echo tipoDesinfeccionTableClass::getNameField(tipoDesinfeccionTableClass::NOMBRE, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objtipoDesinfeccion->$nombre : '' ?>">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="<?php echo tipoDesinfeccionTableClass::getNameField(tipoDesinfeccionTableClass::OBSERVACION, true) ?>" name="<?php echo tipoDesinfeccionTableClass::getNameField(tipoDesinfeccionTableClass::OBSERVACION, true) ?>" required value="<?php echo (isset($edit) and $edit) ? $objtipoDesinfeccion->$observacion : '' ?>">
    </div>
    </div>
  <div class="form-group">
