...
<div class="container container-fluid">
    ...
    <div id="toolBarGeneral" role="toolbar"><!-- subimos los botones listo-->
        <a href="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'new') ?>" class="btn btn-success btn-xs"><i class="fa fa-plus fa-fw"></i><?php echo i18nClass::__('nuevo') ?></a>
        ...
        <a href="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'index').'?r=true' ?>" class="btn btn-default btn-xs"><i class="fa fa-refresh fa-fw "></i><?php echo i18nClass::__('resetear') ?></a>
    </div>
    ...
    <?php else: ?>
        ...
        <form action="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'deleteAll') ?>" method="post" id="gridMain">
                        ...
                        <?php foreach ($objtipoInsumo as $data): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="modalEliminar(<?php echo $data->$id ?>, '<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'delete') ?>', '<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'index') ?>', 'modal<?php echo $data->$id ?>')" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Borrar"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="5" class="text-right">
                                Página <select id="slcPage" data-url="<?php echo mvc\routing\routingClass::getInstance()->getUrlWeb('tipoInsumo', 'index') ?>"><!-- cortamos y cambiamos la direccion donde quiere que nos llegue paginacion-->
...
<?php mvc\view\viewClass::includePartial('tipoInsumo/filters', array('countPages' => $countPages)) ?>
