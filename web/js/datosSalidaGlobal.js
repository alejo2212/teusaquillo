    ...
    $('#btnBuscarControl').click(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#modalBuscar div[class="modal-body"]').append('<table id="tblDatos" class="table table-bordered"><thead><tr><th style="width: 70%;">Nombre</th><th>Cantidad</th></tr></thead><tbody></tbody></table>');
